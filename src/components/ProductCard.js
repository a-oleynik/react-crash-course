...
function Status({stockCount}) {
  const notAvailableTemplate = (<p style={styles.NotAvailableStatus}>Out of stock</p>);
  const availableTemplate = (<p style={styles.AvailableStatus}>{stockCount} items available</p>);
